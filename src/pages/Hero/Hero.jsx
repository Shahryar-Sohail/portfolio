...
export default function Hero() {
  const words = [
    ...
    "AI Integration with RAG & LangChain",
    "Software Engineering Student @ UMT",
  ];

  const [code] = useState(`
const profile = {
    name: 'Shahryar Sohail',
    title: 'Full-Stack Developer | MERN & Django | AI Integration',
    skills: [
        'React', 'NextJS', 'Redux', 'Express',
        'Django', 'MongoDB', 'PostgreSQL', 'TypeScript',
        'LangChain', 'RAG', 'Git', 'Linux', 'Firebase'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  MERN & Django developer 🚀 | AI integration with RAG & LangChain 🤖 | Building scalable web apps 💻✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/shahryar-sohail"
